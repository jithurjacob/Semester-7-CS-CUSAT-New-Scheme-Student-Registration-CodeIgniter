...
* 
*/
class Exam_admin extends CI_Model
{	
    ...
    public function forgot_pwd($value='')
    {
        ...
        if ($query->num_rows == 1) {
            $recoverykey= random_string('alnum', 50);
             ...
             // $this->send_mail($email,"Password reset link","Use the following link to reset your password ".base_url()."index.php/exam/home/resetpwd/resetpwd/".$recoverykey."");
	...
	public function check_login(){
        ...
        if($query->num_rows == 1)
        {
            ...
            $data = array(
                    ...
                    'admin' => true,'college'=>false,'students'=>false,
                    'validated' => true
                    );
