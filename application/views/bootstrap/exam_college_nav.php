...
<?php echo anchor('/exam/colleges/home', 'College Home');?>
                </li>
                
                 
                 
                
                <li class="<?php echo $active == "students"?"active":"";?>">
<?php echo anchor('/exam/colleges/students', 'Student Details');?>
                </li>
                
                <li class="<?php echo $active == "search"?"active":"";?>">
<?php echo anchor('/exam/colleges/search', 'Search');?>
                </li>
                <li class="<?php echo $active == "settings"?"active":"";?>">
<?php echo anchor('/exam/colleges/settings', 'Settings');?>
                </li>
