...
<?php $this->load->helper('form'); $this->load->helper('url');
 echo form_open('exam/loginverify', array('class' => 'form-signin', 'role' => 'form')); ?>
...
<?php echo anchor( '/exam/home/forgotpassword', 'Forgot Password', 'class="pull-left margin_bottom_10 linktext"'); ?>
...
<div class="register">
 ...
 -->
        <?php echo anchor( '/exam/students/register', 'Student', 'class="pull-left linktext"'); ?>
        <!--             </li>
            <li class="pull-right text-right inline linktext"> -->
        <?php //echo anchor( '/exam/company/register', 'Company', 'class="pull-right linktext"'); ?>
        <!-- </li>
        </ul> -->
    </div>
</div>
